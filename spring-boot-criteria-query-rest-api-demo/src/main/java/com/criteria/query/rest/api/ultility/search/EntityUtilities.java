...
import com.criteria.query.rest.api.mapper.BaseMapper;
import com.criteria.query.rest.api.ultility.search.dto.base.AuditableBaseDTO;
import com.criteria.query.rest.api.ultility.search.dto.base.BaseDTO;
import com.criteria.query.rest.api.ultility.search.dto.base.BasePageDTO;
...
public class EntityUtilities {
	 ...
	 * @throws TgxValidationException if object is null
	 */
	 ...
	 * @throws TgxValidationException if string is blank
	 */
	...
	public static <Entity, DTO, PageDTO extends BasePageDTO<DTO>, Mapper extends BaseMapper<DTO, Entity>> PageDTO transferToPageDTO(
		...
		if (verifiedSortOrder != null && !verifiedSortOrder.equals("") && verifiedSortColumn != null
				&& !verifiedSortColumn.equals("")) {
